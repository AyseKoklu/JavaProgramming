...
public class MapClasses {
    public static void main(String[] args) {
        ...
        //    key  ,  value
        Map<Integer, String> hashMap = new HashMap<>(); // fastest, random, accepts null values
        ...
        // System.out.println(hashMap.get()); ---->>> does not have index nums

        Map<Integer, String> linkedHashMap = new LinkedHashMap<>(); // maintains insertion order, accepts null
