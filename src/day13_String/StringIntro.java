...
import java.lang.String; // lang package can be imported implicitly.
// we don't have to write it ourselves, it is done automatically
// for other classes that are not from lang package has to be imported (needs the import statement)
