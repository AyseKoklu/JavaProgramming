...
public class AmazonInc {
    ...
    public static void main(String[] args) {
        ...
        ProductOwner po = new ProductOwner("Soso", 45, 'M', 23, 160000, company);
        BusinessAnalyst ba = new BusinessAnalyst("Tom", 30, 'M', 21, 150000, company);
        ScrumMaster sm = new ScrumMaster("Anna", 29, 'F', 45, 145000, company);
