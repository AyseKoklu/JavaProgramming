...
public class MyOffers {
    ...
    public static void main(String[] args) {
        ...
        offer1.setInfo("WA", "Pho", "SDET", 90000,
                true, true, true, true);

        Offer offer2 = new Offer();
        offer2.setInfo("VA", "Sony Inc", "QA", 120000,
        ...
        System.out.println("Full times = " + fullTimeOffers.size());

        ArrayList<Offer> localOffers = new ArrayList<>(Arrays.asList(myOffers));
        localOffers.removeIf(p -> !(p.location.equals("WA") || p.location.equals("CA")));
