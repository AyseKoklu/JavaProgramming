...
public class replaceAll {
    ...
    public static void main(String[] args) {
        ...
        int[] arr = {10, 10, 10, 20, 30, 40, 50, 30, 30};

        arr = replaceAll(arr, 30, 5);
...
/*
2. RecplaceAll Task:
		2.1 Create a method named replaceAll that passes three parameters: integer array, integer
		oldElement, integer newElement. The method replaces all the element of the array that matching
