...
public class ListOfMapPractice1 {
    ...
    public static void main(String[] args) {
        ...
        scrumTeams.add(scrumTeam1); // this adds only one object (one map) so the size is 1
        scrumTeams.add(scrumTeam2); // size is 2 now
        ...
        // this is an automatic casting to collection, which we wouldn't use ideally
        ...
        for (Map<String, String> eachScrumTeam : scrumTeams) {
            ...
            for (String name : eachScrumTeam.keySet()) {
                if(eachScrumTeam.get(name).equals("SM") ){ ---->>>> get(name) gives us the value
