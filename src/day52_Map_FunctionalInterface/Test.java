...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        MyFirstFunctionalInterface oddOrEvenNumber = (n) -> { // you can give anything for "(n)" but its ideal to give a char
            if (n % 2 == 0) {
