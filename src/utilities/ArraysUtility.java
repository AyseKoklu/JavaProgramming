...
public class ArraysUtility {
    ...
    // checks if the given decimal number is contained in the given array. returns boolean.
    ...
    // removes the decimal number from the array, returns new array
    ...
    // removes the char from the array, returns new array
    ...
    // removes the String from the array, returns new array
